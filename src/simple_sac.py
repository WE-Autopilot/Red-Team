...
class CustomCallback(BaseCallback):
     ...
     def _on_step(self):
         ...
         if(self.num_timesteps % 1000 == 0):
             ...
             print("Safety:",mean(logs["safety"]))
             print("Steering:",mean(logs["steering"]))
             print("Collision:",mean(logs["collision"]))
             print("Center-Bonus",mean(logs["center-bonus"]))
             print("direction",mean(logs["direction"]))
...
def train_model():
    ...
    if choice == "2" :
        ...
        print("Replay buffer size:", model.replay_buffer.size())
